...
ALTER FUNCTION public.nv_magie_distortion(integer, integer, integer) OWNER TO delain;

--
-- Name: FUNCTION nv_magie_distortion(integer, integer, integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION public.nv_magie_distortion(integer, integer, integer) IS 'Lance le sort Distorsion runique';