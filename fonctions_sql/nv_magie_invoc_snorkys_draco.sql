CREATE or replace FUNCTION public.nv_magie_invoc_snorkys_draco(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function magie_invoc_snorkys_draco : lance une invocation de  */
/* snorkys type draconides                                       */
/*  magique                                                      */
...
-------------------------------------------------------------        
    ...
    if lancer_des(1, 100) < 40 then
        v_monstre := cree_monstre_pos(237, v_pos_cible);
...
ALTER FUNCTION public.nv_magie_invoc_snorkys_draco(integer, integer, integer) OWNER TO delain;
