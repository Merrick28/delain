--
-- Name: pot_hortophilie_ultime(integer); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or replace FUNCTION potions.pot_hortophilie_ultime(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION potions.pot_hortophilie_ultime(integer) OWNER TO delain;

--
-- Name: FUNCTION pot_hortophilie_ultime(integer); Type: COMMENT; Schema: potions; Owner: delain
--

COMMENT ON FUNCTION potions.pot_hortophilie_ultime(integer) IS 'Gère la potion de Kharrah’ch l’éternel';
