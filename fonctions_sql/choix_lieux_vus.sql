--
-- Name: choix_lieu_vus(integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

create or replace function choix_lieu_vus(integer, integer) RETURNS SETOF integer
LANGUAGE plpgsql
AS $_$declare
  code_retour text;
...
ALTER FUNCTION public.choix_lieu_vus(integer, integer) OWNER TO delain;