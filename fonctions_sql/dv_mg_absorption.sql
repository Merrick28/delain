CREATE OR REPLACE FUNCTION public.dv_mg_absorption(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-------------------------------------------------------------	
	...
	code_retour := code_retour||'La colère d''Io s''abat sur votre cible, en faisant '||trim(to_char(v_degats,'999999'))||' dégats.<br>';
