CREATE or replace FUNCTION public.nv_magie_vague_destructrice_m(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_vague_destructrice_m(integer, integer, integer) OWNER TO delain;
COMMENT ON FUNCTION public.nv_magie_vague_destructrice_m(integer, integer, integer) IS 'Vague Destructrice pour les monstres';
