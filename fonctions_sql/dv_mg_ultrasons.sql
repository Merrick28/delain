CREATE or replace FUNCTION public.dv_mg_ultrasons(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- on enlève les bonus existants
    ...
    code_retour := code_retour || '<br>' || nom_cible || ' entendra mal pendant 2 tours.<br>';
...
ALTER FUNCTION public.dv_mg_ultrasons(integer, integer, integer) OWNER TO delain;
