CREATE or replace FUNCTION public.nv_magie_armure_surprise(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function magie_armure_surprise : lance le sort                */
...
-- OK on créé l'élémentaire	
    v_monstre := cree_objet_pos(85, v_pos);
...
ALTER FUNCTION public.nv_magie_armure_surprise(integer, integer, integer) OWNER TO delain;
