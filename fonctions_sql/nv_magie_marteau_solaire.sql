CREATE OR REPLACE FUNCTION public.nv_magie_marteau_solaire(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-- on vérifié qu'il n'y ait pas une arme
	...
	code_retour := code_retour||'<br>Vous avez dans votre main un marteau solaire. Celui ci existera pendant 48 heures.';
