--
-- Name: pot_intelligence_faible(integer); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or replace FUNCTION potions.pot_intelligence_faible(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION potions.pot_intelligence_faible(integer) OWNER TO delain;