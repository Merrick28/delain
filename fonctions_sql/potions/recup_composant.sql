--
-- Name: recup_composant(integer, integer, numeric); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or replace FUNCTION potions.recup_composant(integer, integer, numeric) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION potions.recup_composant(integer, integer, numeric) OWNER TO delain;

--
-- Name: FUNCTION recup_composant(integer, integer, numeric); Type: COMMENT; Schema: potions; Owner: delain
--

COMMENT ON FUNCTION potions.recup_composant(integer, integer, numeric) IS 'Gère le ramassage d’un ou plusieurs composants.';