--
-- Name: pot_antidote(integer); Type: FUNCTION; Schema: potions; Owner: postgres
--

CREATE or replace FUNCTION potions.pot_antidote(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
begin
  ...
  delete from bonus where
    ...
    code_retour := code_retour||'Vous avez supprimé tous les bonus/malus liés au poison';
  end if;
  return code_retour;
end;
$_$;
...
ALTER FUNCTION potions.pot_antidote(integer) OWNER TO delain;