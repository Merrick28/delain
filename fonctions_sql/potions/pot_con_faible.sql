...
--
-- Name: pot_con_faible(integer); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or replace FUNCTION potions.pot_con_faible(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
begin
  ...
  /*Tous les controles sont OK, on passe alors aux effets de la potion uniquement*/
    ...
    perform f_modif_carac(personnage,'CON',duree,1);
...
ALTER FUNCTION potions.pot_con_faible(integer) OWNER TO delain;