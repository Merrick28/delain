--
-- Name: pot_con_moyenne(integer); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or replace FUNCTION potions.pot_con_moyenne(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION potions.pot_con_moyenne(integer) OWNER TO delain;