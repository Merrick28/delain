...
--
-- Name: pot_creusage(integer); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or replace FUNCTION potions.pot_creusage(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION potions.pot_creusage(integer) OWNER TO delain;