CREATE or replace FUNCTION public.nv_magie_elementaire_terre(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- OK on créé l'élémentaire	
    v_monstre := cree_monstre_pos(187, v_pos);
    code_retour := code_retour || '<br>Vous avez invoqué avec succès un élémentaire de terre.';
...
ALTER FUNCTION public.nv_magie_elementaire_terre(integer, integer, integer) OWNER TO delain;
