...
--
-- Name: entrer_gm(integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION entrer_gm(integer) RETURNS void
    LANGUAGE plpgsql
    AS $_$/* *********************************************** */
/* Fonction entrer_gm                              */
/*                                                 */
...
ALTER FUNCTION public.entrer_gm(integer) OWNER TO delain;