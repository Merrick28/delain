--
-- Name: copier_etage_par_morceau(integer, integer, integer, integer, integer, integer, integer, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION copier_etage_par_morceau(integer, integer, integer, integer, integer, integer, integer, integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/********************************************************/
...
ALTER FUNCTION public.copier_etage_par_morceau(integer, integer, integer, integer, integer, integer, integer, integer, integer, integer) OWNER TO delain;

--
-- Name: FUNCTION copier_etage_par_morceau(integer, integer, integer, integer, integer, integer, integer, integer, integer, integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION copier_etage_par_morceau(integer, integer, integer, integer, integer, integer, integer, integer, integer, integer) IS 'Copie un bout d’étage vers un autre étage.
Attention, la procédure n’est vraiment pas optimisée et peut être longue... Mais comme il ne s’agit que d’une mise à jour très ponctuelle, ce n’est pas trop gênant.';
