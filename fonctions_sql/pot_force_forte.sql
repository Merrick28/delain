--
-- Name: pot_force_forte(integer); Type: FUNCTION; Schema: potions; Owner: delain
--

CREATE or REPLACE FUNCTION potions.pot_force_forte(integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION potions.pot_force_forte(integer) OWNER TO delain;
