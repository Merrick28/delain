...
ALTER FUNCTION public.f_repare_armure(integer, integer) OWNER TO delain;

--
-- Name: FUNCTION f_repare_armure(integer, integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION public.f_repare_armure(integer, integer) IS 'Gère la réparation d’une armure.';