CREATE or replace FUNCTION public.nv_magie_bernard_lhermite(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function magie_bernard_lhermite : lance le sort Bernard       */
/*   l'hermite                                                   */
...
ALTER FUNCTION public.nv_magie_bernard_lhermite(integer, integer, integer) OWNER TO delain;
