--
-- Name: controle_sort_case(integer, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION controle_sort_case(integer, integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/************************************************/
...
ALTER FUNCTION public.controle_sort_case(integer, integer, integer, integer) OWNER TO delain;