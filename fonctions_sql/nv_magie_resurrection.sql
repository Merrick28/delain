CREATE or replace FUNCTION public.nv_magie_resurrection(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
--- en prenant garde à ne laisser qu'une seule itération possible pour un code perso.
    ...
    select into v_pos_resuc rpos_pos_cod
    from perso_resuc
...
ALTER FUNCTION public.nv_magie_resurrection(integer, integer, integer) OWNER TO delain;
