...
ALTER FUNCTION public.deb_tour_rouille(integer, integer, integer, integer) OWNER TO delain;

--
-- Name: FUNCTION deb_tour_rouille(integer, integer, integer, integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION public.deb_tour_rouille(integer, integer, integer, integer) IS 'Impact l''usure des objets, et permet des effets multiples (acide, rouille, ...)';
