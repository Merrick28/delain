CREATE OR REPLACE FUNCTION public.nv_magie_poison(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
--------------------	
	...
	code_retour := code_retour||'<br>'||nom_cible||' a un poison de '||trim(to_char(v_malus_armure,'99'))||' dans les veines pendant 4 tours.';
