CREATE OR REPLACE FUNCTION public.deb_tour_degats(integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/************************************************/
...
CREATE OR REPLACE FUNCTION public.deb_tour_degats(integer, text, integer, character, text, numeric, text)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/**************************************************/
/* deb_tour_degats                                */
...
CREATE OR REPLACE FUNCTION public.deb_tour_degats(integer, text, integer, character, text, numeric, text, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/**************************************************/
/* deb_tour_degats                                */
