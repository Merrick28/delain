CREATE or replace FUNCTION public.dv_mg_voie_ecatis(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function dv_mg_voie_ecatis                                    */
...
-------------------------------------------------------------	
    ...
    where perso_cod = cible;
    code_retour := code_retour || 'La cible perd de son karma.<br>';
...
ALTER FUNCTION public.dv_mg_voie_ecatis(integer, integer, integer) OWNER TO delain;
