CREATE or replace FUNCTION public.nv_magie_passage_inverse(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_passage_inverse(integer, integer, integer) OWNER TO delain;
