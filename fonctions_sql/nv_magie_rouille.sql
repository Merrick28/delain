CREATE OR REPLACE FUNCTION public.nv_magie_rouille(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
texte_evt := 'Votre '||obj_cible_nom||' a subit un sort direct, rendant son utilisation plus hasardeuse sans réparation !';
