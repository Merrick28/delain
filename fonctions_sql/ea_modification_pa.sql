--
-- Name: ea_modification_pa(integer, integer, integer, character, text, numeric, text, json); Type: FUNCTION; Schema: public; Owner: delain
--

create or replace function ea_modification_pa(integer, integer, integer, character, text, numeric, text, json) RETURNS text
LANGUAGE plpgsql
AS $_$/**************************************************/
/* ea_modification_pa                             */
...
declare
  ...
  v_nb_pa integer;              -- nombre de PA ajouter ou retirer
  v_pa_fixer text ;             -- si O, on fixe le nombre de PA à v_nb_pa, sinon on ajoute ou retire v_nb_pa
...
begin
  ...
  v_pa_fixer := (v_params->>'fonc_trig_pa_fixer')::text ;
  ...
  loop
    ...
    v_nb_pa := f_lit_des_roliste((v_params->>'fonc_trig_nb_pa')::text);
...
ALTER FUNCTION public.ea_modification_pa(integer, integer, integer, character, text, numeric, text, json) OWNER TO delain;
