CREATE OR REPLACE FUNCTION public.dv_mg_malchance_totale(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-- on enlève les bonus existants
	...
	code_retour := code_retour||'<br>'||nom_cible||' a un malus de '||trim(to_char(v_bonus,'999999'))||' en esquive pendant 2 tours.<br>';
