CREATE OR REPLACE FUNCTION public.nv_magie_surprise(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
------------------------
	...
	code_retour := code_retour||'<br>Vous avez créé l''objet <b>'||nom_objet||'</b> dans l''inventaire de '||nom_cible||'.<br>';
