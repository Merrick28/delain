CREATE OR REPLACE FUNCTION public.nv_magie_glyphe_resurrection(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
 STRICT
AS $function$/*****************************************************************/
...
-- on vérifie que le lanceur n''a pas déjà un glyphe de résurrection
    ...
    update objets set obj_nom = 'Glyphe de résurrection de ' || nom_cible,obj_nom_generique =  'Glyphe de résurrection de ' || nom_cible where obj_cod = num_objet;
    ...
    code_retour := code_retour||'<br>Vous avez créé sur le sol un glyphe de résurrection. Vous rejoindrez ce glyphe à votre prochaine mort.';
