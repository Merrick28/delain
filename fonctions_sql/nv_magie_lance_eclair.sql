CREATE OR REPLACE FUNCTION public.nv_magie_lance_eclair(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-- on vérifié qu'il n'y ait pas une arme
	...
	code_retour := code_retour||'<br>Vous avez dans votre main une lance d''éclair. Celle ci existera pendant 48 heures.';
