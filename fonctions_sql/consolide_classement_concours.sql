--
-- Name: consolide_classement_concours(); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE or replace FUNCTION consolide_classement_concours() RETURNS text
    LANGUAGE plpgsql
    AS $$/* ****************************************************************
...
ALTER FUNCTION public.consolide_classement_concours() OWNER TO delain;

--
-- Name: FUNCTION consolide_classement_concours(); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION consolide_classement_concours() IS 'Met à jour les classements, pour les concours en cours (pour le moment, ne gère que les collections).';
