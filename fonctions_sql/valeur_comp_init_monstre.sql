CREATE OR REPLACE FUNCTION public.valeur_comp_init_monstre(integer, integer)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$/*****************************************/
/* valeur_comp_init_monstre              */
/*  $1 = perso_cod                       */
/*  $2 = comp_cod                        */
...
begin
	select into v_for,v_dex,v_con,v_int
		gmon_for,gmon_dex,gmon_con,gmon_int
		from monstre_generique where gmon_cod = personnage;
