--
-- Name: ressuscite_familier_divin(integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE or REPLACE function ressuscite_familier_divin( integer) RETURNS text
LANGUAGE plpgsql
AS $_$/*****************************************************************/
...
ALTER FUNCTION public.ressuscite_familier_divin(integer) OWNER TO delain;

--
-- Name: FUNCTION ressuscite_familier_divin(integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION ressuscite_familier_divin(integer) IS 'Réssucscite un familier divin, sauf si celui si est mort à cause de son manque de foi.';
