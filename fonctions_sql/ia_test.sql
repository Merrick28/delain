-- Function: public.ia_test(integer)

-- DROP FUNCTION public.ia_test(integer);

CREATE OR REPLACE FUNCTION public.ia_test(integer)
  RETURNS text AS
$BODY$/*****************************************************/
...
begin
	doit_jouer := 0;
	code_retour := 'IA test<br>Monstre '||trim(to_char(v_monstre,'999999999999'))||'<br>';
	limite_surcharge := 1;
/***********************************/
...
/***********************************/
	...
	i_temps_tour := v_temps_tour||' minutes';
...
/*************************************************/
  ...
  COST 100;
ALTER FUNCTION public.ia_test(integer)
  OWNER TO delain;
