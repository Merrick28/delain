--
-- Name: controle_sort_dieu(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE  or replace FUNCTION controle_sort_dieu(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/************************************************/
...
ALTER FUNCTION public.controle_sort_dieu(integer, integer, integer) OWNER TO delain;
