CREATE or replace FUNCTION public.dv_mg_mal_ecatis(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-------------------------------------------------------------	
    ...
    code_retour := code_retour ||
                   'La cible est maudite par Ecatis, les dégats qui lui sont fait par des nains, elfes, humains et leurs familiers  sont accrus.<br>';
...
ALTER FUNCTION public.dv_mg_mal_ecatis(integer, integer, integer) OWNER TO delain;
