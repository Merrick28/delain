--
-- Name: nv_magie_nettoyage(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION public.nv_magie_nettoyage(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/*****************************************************************/
...
-------------------------------------------------------------
	...
	where bonus_perso_cod = cible
	  and bonus_mode != 'E'    -- sauf bonus d'équipement
...
ALTER FUNCTION public.nv_magie_nettoyage(integer, integer, integer) OWNER TO delain;

--
-- Name: FUNCTION nv_magie_nettoyage(integer, integer, integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION public.nv_magie_nettoyage(integer, integer, integer) IS 'Lance le sort Nettoyage';