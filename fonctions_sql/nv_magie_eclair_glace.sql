CREATE or replace FUNCTION public.nv_magie_eclair_glace(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_eclair_glace(integer, integer, integer) OWNER TO delain;
