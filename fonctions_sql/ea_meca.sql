--
-- Name: ea_meca(integer, numeric, text, json); Type: FUNCTION; Schema: public; Owner: delain
--

create or replace function ea_meca(integer, numeric, text, json) RETURNS text
LANGUAGE plpgsql
AS $_$/**************************************************/
/* ea_meca                             */
...
ALTER FUNCTION public.ea_meca(integer, numeric, text, json) OWNER TO delain;
