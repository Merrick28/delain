--
-- Name: choix_cible_case(integer, integer, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

create or replace function choix_cible_case(integer, integer, integer, integer, integer) RETURNS integer
LANGUAGE plpgsql
AS $_$/****************************************************/
...
ALTER FUNCTION public.choix_cible_case(integer, integer, integer, integer, integer) OWNER TO delain;