CREATE or replace FUNCTION public.nv_magie_invoc_snorkys_farfa(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function magie_invoc_snorkys_farfa : lance une invocation de  */
/*    snorkys type farfadet                                      */
/*  magique                                                      */
...
-------------------------------------------------------------        
    ...
    if lancer_des(1, 100) < 40 then
        v_monstre := cree_monstre_pos(236, v_pos_cible);
...
ALTER FUNCTION public.nv_magie_invoc_snorkys_farfa(integer, integer, integer) OWNER TO delain;
