--
-- Name: nv_magie_lache_ca(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION nv_magie_lache_ca(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_lache_ca(integer, integer, integer) OWNER TO delain;