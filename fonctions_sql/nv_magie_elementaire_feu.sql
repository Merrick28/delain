CREATE or replace FUNCTION public.nv_magie_elementaire_feu(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- OK on créé l'élémentaire	
    ...
    code_retour := code_retour || '<br>Vous avez invoqué avec succès un élémentaire de feu.';
...
ALTER FUNCTION public.nv_magie_elementaire_feu(integer, integer, integer) OWNER TO delain;
