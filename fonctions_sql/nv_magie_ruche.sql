CREATE OR REPLACE FUNCTION public.nv_magie_ruche(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-- OK on créé l'élémentaire	
	...
	code_retour := code_retour||'<br>Vous avez invoqué avec succès '||trim(to_char(nb_monstre,'99999'))||' essaims d''abeille.';
