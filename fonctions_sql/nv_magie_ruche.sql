CREATE or replace FUNCTION public.nv_magie_ruche(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function magie_ruche : lance le sort                        */
...
-- OK on créé l'élémentaire	
    ...
    for num_monstre in 1..nb_monstre
        loop
            v_monstre := cree_monstre_pos(10, v_pos);
        end loop;
...
ALTER FUNCTION public.nv_magie_ruche(integer, integer, integer) OWNER TO delain;
