--
-- Name: defi_reinitialise_persos(integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION defi_reinitialise_persos(integer) RETURNS void
    LANGUAGE plpgsql
    AS $_$/*************************************************************/
...
ALTER FUNCTION public.defi_reinitialise_persos(integer) OWNER TO delain;

--
-- Name: FUNCTION defi_reinitialise_persos(integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION defi_reinitialise_persos(integer) IS 'Remet les persos à leur état initial suite à un défi.';