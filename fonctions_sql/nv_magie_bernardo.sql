CREATE OR REPLACE FUNCTION public.nv_magie_bernardo(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
--------------------		   
	...
	code_retour := code_retour||'<br>'||nom_cible||' ne pourra pas envoyer de message pendant '||trim(to_char(duree,'99'))||' tours.<br>';
