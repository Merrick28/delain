--
-- Name: perso_bonus(integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE or REPLACE FUNCTION perso_bonus(integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/***********************************/
/* perso_bonus                     */
/* $1 = perso_cod                  */
...
ALTER FUNCTION public.perso_bonus(integer) OWNER TO delain;