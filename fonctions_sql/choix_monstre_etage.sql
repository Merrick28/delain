-- Function: public.choix_monstre_etage(integer)

-- DROP FUNCTION public.choix_monstre_etage(integer);

CREATE OR REPLACE FUNCTION public.choix_monstre_etage(integer)
  RETURNS integer AS
$BODY$/******************************************************/
...
begin
  ...
  COST 100;
ALTER FUNCTION public.choix_monstre_etage(integer)
  OWNER TO delain;
GRANT EXECUTE ON FUNCTION public.choix_monstre_etage(integer) TO delain;
GRANT EXECUTE ON FUNCTION public.choix_monstre_etage(integer) TO public;
COMMENT ON FUNCTION public.choix_monstre_etage(integer) IS 'Choisit le monstre à ajouter à l’étage.';
