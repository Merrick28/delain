CREATE or replace FUNCTION public.nv_magie_boule_feu(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- NOMBRE DE CIBLES MAX = INT/2
    ...
    code_retour := code_retour || '<b> Intelligence/2 = ' || v_int_lanceur_txt ||
                   ' Cibles au maximum</b> (cible principale comprise et bonus mage de bataille inclus)<br>';
...
ALTER FUNCTION public.nv_magie_boule_feu(integer, integer, integer) OWNER TO delain;
