CREATE or replace FUNCTION public.dv_mg_chance_enorme(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- on enlève les bonus existants
    ...
    values (3, lanceur, cible, 2.5 * ln(v_pv_cible));
...
ALTER FUNCTION public.dv_mg_chance_enorme(integer, integer, integer) OWNER TO delain;
