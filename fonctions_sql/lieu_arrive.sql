CREATE OR REPLACE FUNCTION public.lieu_arrive()
 RETURNS integer
 LANGUAGE plpgsql
AS $function$/*************************************************************/
...
CREATE OR REPLACE FUNCTION public.lieu_arrive(integer)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$/*************************************************************/
/* fonction lieu_arrive : donne un pos_cod au lvl 0 pour les */
/*   lieux d’arrivée sans aléatoire                          */
/*************************************************************/
declare
	compte alias for $1;
        code_retour integer;
