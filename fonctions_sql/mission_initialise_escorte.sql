CREATE OR REPLACE FUNCTION public.mission_initialise_escorte(integer, integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$/*************************************************************/
/* fonction mission_initialise_escorte                       */
/*   Crée une mission de type « escorte » dans               */
...
begin
	code_mission := 4;         -- Mission de type escorte
	...
	-- On détermine le délai de réalisation (de 15 à 25 jours)
	v_delai := 14 + lancer_des(1, 10);
