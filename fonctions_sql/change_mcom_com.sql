--
-- Name: change_mcom_cod(integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE or replace FUNCTION change_mcom_cod(integer, integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/*************************************************/
...
ALTER FUNCTION public.change_mcom_cod(integer, integer) OWNER TO delain;