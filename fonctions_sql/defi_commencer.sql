CREATE OR REPLACE FUNCTION public.defi_commencer(integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*************************************************************/
...
begin
	...
	insert into defi_bmcaracs (dbmc_perso_cod, dbmc_type_carac, dbmc_duree, dbmc_nb_tour, dbmc_valeur)
	...
	case corig_type_carac when 'FOR' then perso_for 
	                      ...
	                      when 'DEX' then perso_dex end - corig_carac_valeur_orig
