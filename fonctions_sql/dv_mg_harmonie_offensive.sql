CREATE OR REPLACE FUNCTION public.dv_mg_harmonie_offensive(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
/* function dv_mg_harmonie_offensive                             */
...
-------------------------------------------------------------	
	...
	perform ajoute_bonus(cible, 'HOF', 1, 25);
	code_retour := code_retour||'La cible reçoit un bonus de 25% au tir à ''arc.<br>';
