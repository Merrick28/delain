CREATE or replace FUNCTION public.dv_mg_harmonie_offensive(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.dv_mg_harmonie_offensive(integer, integer, integer) OWNER TO delain;
