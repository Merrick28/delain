CREATE or replace FUNCTION public.nv_magie_armure_dure(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_armure_dure(integer, integer, integer) OWNER TO delain;
