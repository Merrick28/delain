CREATE OR REPLACE FUNCTION public.nv_magie_attaque_mentale(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
select into nom_cible,v_pv_cible,int_cible perso_nom,perso_pv_max,perso_int from perso
...
code_retour := code_retour||'<br>Vous penetrez l''esprit de votre adversaire, lui infligeant une douleur insoutenable '||nom_cible||'<br>';
