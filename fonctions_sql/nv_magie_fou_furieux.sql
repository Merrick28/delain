CREATE or replace FUNCTION public.nv_magie_fou_furieux(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- on enlève les bonus existants
    ...
    code_retour := code_retour || '<br>' || nom_cible ||
                   ' gagne un bonus de -3PA par attaque pendant 1 tour (minimum 2PA par attaque).<br>';
...
ALTER FUNCTION public.nv_magie_fou_furieux(integer, integer, integer) OWNER TO delain;
