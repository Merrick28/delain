CREATE or replace FUNCTION public.nv_magie_boule_feu_test3(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_boule_feu_test3(integer, integer, integer) OWNER TO delain;
