CREATE OR REPLACE FUNCTION public."dv_mg_cecité"(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
/* function dv_mg_faiblesse : lance le sort cecité lunaire       */
...
-- on enlève les bonus existants
	...
	code_retour := code_retour||'<br>'||nom_cible||' est atteint de brusque cecité et a un malus de -2 en vue pendant 2 tours.<br>';
