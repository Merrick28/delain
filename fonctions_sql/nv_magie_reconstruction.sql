CREATE or replace FUNCTION public.nv_magie_reconstruction(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_reconstruction(integer, integer, integer) OWNER TO delain;
