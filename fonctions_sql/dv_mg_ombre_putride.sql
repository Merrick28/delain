CREATE or replace FUNCTION public.dv_mg_ombre_putride(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function dv_mg_ombre_putride: lance le sort ombre putride     */
...
-------------------------------------------------------------	
    ...
    v_monstre := cree_monstre_pos(448, v_pos_cible);
    ...
    code_retour := code_retour || 'Vous avez invoqué une ombre putride qui attaque votre cible.<br>';
...
ALTER FUNCTION public.dv_mg_ombre_putride(integer, integer, integer) OWNER TO delain;
