--
-- Name: ia_monture(integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE or REPLACE FUNCTION ia_monture(integer) RETURNS text
    LANGUAGE plpgsql
    AS $_$/*****************************************************/
/* fonction ia_monture                             */
/*    reçoit en arguments :                          */
...
ALTER FUNCTION public.ia_monture(integer) OWNER TO delain;
