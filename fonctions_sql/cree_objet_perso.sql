CREATE OR REPLACE FUNCTION public.cree_objet_perso(
    integer,
    integer)
    RETURNS integer
    LANGUAGE 'plpgsql'
...
ALTER FUNCTION public.cree_objet_perso(integer, integer)
    OWNER TO delain;

COMMENT ON FUNCTION public.cree_objet_perso(integer, integer)
    IS 'Crée un objet identifié dans l’inventaire d’un personnage';
...
ALTER FUNCTION public.cree_objet_perso(integer, integer, character)
    OWNER TO delain;

COMMENT ON FUNCTION public.cree_objet_perso(integer, integer, character)
    IS 'Crée un objet dans l’inventaire d’un perso, identifié ou non.';
