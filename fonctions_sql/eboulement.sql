...
--
-- Name: eboulement(integer, integer); Type: FUNCTION; Schema: public; Owner: delain
--

CREATE OR REPLACE FUNCTION public.eboulement(etage_cod integer, nouveaux_murs integer) RETURNS text
...
ALTER FUNCTION public.eboulement(etage_cod integer, nouveaux_murs integer) OWNER TO delain;
