CREATE or replace FUNCTION public.dv_mg_effroi(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-------------------------------------------------------------	
    ...
    code_retour := code_retour ||
                   'La cible a un malus de +1Pa par attaque, sa DLT a été repoussé&e de 3 heures, et elle gagne +3 en dégats.<br>';
...
ALTER FUNCTION public.dv_mg_effroi(integer, integer, integer) OWNER TO delain;
