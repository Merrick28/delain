CREATE or replace FUNCTION public.nv_magie_conscience_flux(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function magie_conscience_flux : sort conscience des flux     */
...
-------------------------------------------------------------
    ...
    v_perso_int              integer; -- int du perso
-------------------------------------------------------------
...
ALTER FUNCTION public.nv_magie_conscience_flux(integer, integer, integer) OWNER TO delain;
