CREATE or replace FUNCTION public.dv_mg_noirepine(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.dv_mg_noirepine(integer, integer, integer) OWNER TO delain;
