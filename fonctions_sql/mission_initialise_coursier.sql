CREATE OR REPLACE FUNCTION public.mission_initialise_coursier(integer, integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$/*************************************************************/
/* fonction mission_initialise_coursier                      */
/*   Crée une mission de type « coursier » dans              */
...
begin
	code_mission := 14;         -- Mission de type coursier
