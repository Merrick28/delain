CREATE OR REPLACE FUNCTION public.dv_mg_farfadet(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-- niveau du lanceur
	...
	code_retour := code_retour||'<br>'||'Vous avez créé '||trim(to_char(v_bonus,'999999'))||' brouzoufs de farfadets sur la case.<br>';
