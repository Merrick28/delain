CREATE OR REPLACE FUNCTION public.dv_mg_lame_destin(integer, integer, integer)
 RETURNS text
 LANGUAGE plpgsql
AS $function$/*****************************************************************/
...
-------------------------------------------------------------	
	...
	code_retour := code_retour||'Son armure est de '||trim(to_char(f_armure_perso(v_cible),'999999'))||', vous causez donc '||trim(to_char(v_degats,'999999'))||' d&#233;gats.<br>';
