CREATE or replace FUNCTION public.dv_mg_ombre_mineure(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.dv_mg_ombre_mineure(integer, integer, integer) OWNER TO delain;
