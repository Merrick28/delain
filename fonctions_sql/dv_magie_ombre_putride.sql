CREATE or replace FUNCTION public.dv_magie_ombre_putride(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
/* function dv_mg_aimant : lance le sort ombre putride           */
...
ALTER FUNCTION public.dv_magie_ombre_putride(integer, integer, integer) OWNER TO delain;
