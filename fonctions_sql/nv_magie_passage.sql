CREATE or replace FUNCTION public.nv_magie_passage(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
-- lieu d'origine
    ...
    values (v_lieu, 10, 'Passage magique',
            ...
            'N', 'passage.php', v_pos, now() + v_delai);
...
ALTER FUNCTION public.nv_magie_passage(integer, integer, integer) OWNER TO delain;
