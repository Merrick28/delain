--
-- Name: obj_verif_perso_condition(integer,integer); Type: FUNCTION; Schema: potions; Owner: postgres
--

CREATE or REPLACE FUNCTION obj_verif_perso_condition(integer,integer) RETURNS integer
LANGUAGE plpgsql
AS $_$/*********************************************************/
...
ALTER FUNCTION obj_verif_perso_condition(integer,integer) OWNER TO delain;
