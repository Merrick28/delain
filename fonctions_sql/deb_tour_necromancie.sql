...
ALTER FUNCTION public.deb_tour_necromancie(integer, numeric, integer) OWNER TO delain;

--
-- Name: FUNCTION deb_tour_necromancie(integer, numeric, integer); Type: COMMENT; Schema: public; Owner: delain
--

COMMENT ON FUNCTION public.deb_tour_necromancie(integer, numeric, integer) IS 'monstre, facteur de puissance de la necromancie (monstre qui apparait, 1 par défaut), pouvoir nécromantique (chance que cela se déclenche)';
