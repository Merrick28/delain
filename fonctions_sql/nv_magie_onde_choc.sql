CREATE or replace FUNCTION public.nv_magie_onde_choc(integer, integer, integer) RETURNS text
    LANGUAGE plpgsql
AS
$_$/*****************************************************************/
...
ALTER FUNCTION public.nv_magie_onde_choc(integer, integer, integer) OWNER TO delain;
