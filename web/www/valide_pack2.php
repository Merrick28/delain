...
switch($methode)
{
	case "cree":
		...
		{
			if ($_POST['opera'] == 'opera')
			{
				setcookie(opera,$opera,time()+31536000,"/");
				setcookie(opera,$opera,time()+31536000,"/jeu/");
				$_COOKIE['opera'] = $opera;
			}
			else
			{
				setcookie(opera,'',time()-31536000,"/");
				setcookie(opera,'',time()-31536000,"/jeu/");
				$_COOKIE['opera'] = 'non';
			}
		}
