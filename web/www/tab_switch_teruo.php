...
function affiche_perso($perso_cod)
{
	...
	$db2 = new base_delain;
	if ($db->f("perso_avatar") != 'crapaud.jpg')
	{
	if ($db->f("perso_race_cod") < 4)
	{
		if ($db->f("perso_race_cod")==1)
		{
			$avatar = "https://www.jdr-delain.net/avatars/humainStV" . $db->f("perso_sex") . ".png";
		}
		else
		{
			if ($db->f("perso_race_cod")==2)
			{
			$avatar = "https://www.jdr-delain.net/avatars/nainStV" . $db->f("perso_sex") . ".png";
			}
			else		
			{
				if ($db->f("perso_race_cod")==3)
				{
				$avatar = "https://www.jdr-delain.net/avatars/elfeStV" . $db->f("perso_sex") . ".png";
				}
			}
		}
	}
