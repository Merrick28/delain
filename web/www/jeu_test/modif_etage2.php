...
// POSITION DU JOUEUR
    ...
    <form name="action_mur" method="post">
        <select name="methode">
            ...
            <option value="modif_decor" <?php if ($_POST['methode'] == "modif_decor") echo "selected"; ?>>modifier décor
        ...
        Modificateur déplacement<input type="text" name="deplacement" value="0"><em>(positif les déplacements coutent
