...
<option value="modif_decor" <?php if($_POST['methode'] == "modif_decor") echo "selected";?>>modifier décor et routes (nombre de PA pour déplacement)</option>
</select>
...
?>
	<td width="20" height="20" ><div id="pos_<?php echo  $db->f("pos_cod");?>" style="width:25px;height:25px;background-color:<?php echo $color?>;<?php echo $decor?>" onClick="valActionMur(<?php echo  $db->f("pos_cod");?>);"><span style="font-size:9px;"><?php echo $db->f("mur_usure");?> <?php echo $db->f("mur_richesse");?> <?php echo $dep;?></span></div></td>
<?php 
