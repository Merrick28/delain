...
if(($valeur_comp_niv1 == 0) && ($valeur_comp_niv2 == 0) && ($valeur_comp_niv3 == 0)){
?>
<p>Ainsi donc tu viens ici pour la première fois, petit. Je peux te faire profiter de mon expérience, moyennant bien sur une petite compensation financière.</p>
...
?>
<p>Tu nes pas encore assez doué pour passer à létape suivante, mais je ne peux plus tentraîner, tu dois apprendre par toi-même.</p>
<?php 
} else if(($valeur_comp_niv2 == 0) && ($valeur_comp_niv3 == 0)){
?>
<p>Ah ! Il semblerait que tu ne sois pas tout à fait irrécupérable, si tu veux tu peux apprendre quelques techniques plus avancées. Moyennant bien sur une petite compensation financière. </p>
<form name="upgrade_voleur" method="post">
<input type="hidden" name="methode" value="update_comp_lvl_2">
<input type="submit" value="Apprendre le vol lvl 2 (<?php  echo 2*$coutpa;?> PA, <?php  echo 2*$cout;?>Br)">
</form>
<?php 
...
?>
<p>Bien voilà un élève prometteur, tu pourras faire encore mieux si tu perfectionne encore ta technique avec quelques trucs supplémentaires  </p>
<form name="upgrade_voleur" method="post">
<input type="hidden" name="methode" value="update_comp_lvl_3">
<input type="submit" value="Apprendre le vol lvl 3 (<?php  echo 3*$coutpa;?> PA, <?php  echo 3*$cout;?>Br)">
</form>
<?php  } else {?>
