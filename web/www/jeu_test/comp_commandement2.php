            ...
            while ($db->next_record())
            {
                ...
                <tr>
                    <td <?php echo $cl; ?>>
                        <input type="checkbox" name="subalterne_cod[]"
                               value="<?php echo $db->f("perso_subalterne_cod"); ?>"> <a
                                href="javascript:document.visu_evt2.cible.value=<?php echo $db->f("perso_subalterne_cod"); ?>;"> <?php echo $db->f("perso_nom"); ?></a>
                    </td>
                    <td <?php echo $cl; ?>>
                ...
                <tr>
                    <td <?php echo $cl; ?> colspan="5">
                        <font style="font-size:7pt;"><?php echo $db->f("perso_description"); ?></font></td>
                </tr>
            ...
            <select name="nouv_perso_cod">
                ...
                while ($db->next_record())
                {
                    ...
                    <option value="<?php echo $db->f("perso_cod") ?>"> <?php echo $db->f("perso_nom") ?>
                        (<?php echo $db->f("pos_x") ?>,<?php echo $db->f("pos_y") ?>) <?php echo $db->f("perso_pa") ?>PA
                    </option>
                    <?php
                }
                ?>
