...
if($result = $stmt->fetch())
{
    ...
    <form method="post" name="troupes" action="comp_commandement.php">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="soustitre2" width="20%">Nom
                </td>
                <td class="soustitre2" width="10%">Position
                </td>
                <td class="soustitre2" width="10%">DLT
                </td>
                <td class="soustitre2" width="7%">PA
                </td>
                <td class="soustitre2" width="15%">Etat
                </td>
                <td class="soustitre2" width="10%">IA Actuelle
                </td>
                <td class="soustitre2" width="10%">Statique En combat/hors Combat
                </td>
                <td class="soustitre2" width="25%">Locks combat
                </td>
                <td class="soustitre2" width="25%">Lancer l'IA manuellement
                </td>
            </tr>
            <?php
            ...
            while ($result = $stmt->fetch())
            {
                ...
                <tr>
                    <td <?php echo $cl; ?>>
                        <input type="checkbox" name="subalterne_cod[]"
                               value="<?php echo $result['perso_subalterne_cod']; ?>"> <a
                                href="javascript:document.visu_evt2.cible.value=<?php echo $result['perso_subalterne_cod']; ?>;"> <?php echo $result['perso_nom']; ?></a>
                    </td>
                    <td <?php echo $cl; ?>>
                ...
                <tr>
                    <td <?php echo $cl; ?> colspan="5">
                        <font style="font-size:7pt;"><?php echo $result['perso_description']; ?></font></td>
                </tr>
        ...
        Statique en combat:Oui<input type="radio" name="perso_sta_combat" value="O"> Non<input checked type="radio"
                                                                                               name="perso_sta_combat"
                                                                                               value="N"><br>
        Statique hors combat:Oui<input type="radio" name="perso_sta_hors_combat" value="O"> Non<input checked
                                                                                                      type="radio"
        ...
        Modifier l'IA:<select name="pia_ia_type">
            ...
            //while($result = $stmt->fetch())
            //{
            //	echo "<option value=\"" , $result['ia_type'] , "\">" , $result['ia_nom'] , "</option>\n";
            //}
            ?>
        </select>
            ...
            <select name="nouv_perso_cod">
                ...
                while ($result = $stmt->fetch())
                {
                    ...
                    <option value="<?php echo $result['perso_cod'] ?>"> <?php echo $result['perso_nom'] ?>
                        (<?php echo $result['pos_x'] ?>,<?php echo $result['pos_y'] ?>) <?php echo $result['perso_pa'] ?>PA
                    </option>
                    <?php
                }
                ?>
