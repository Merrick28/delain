	...
	switch($methode)
	{
		...
		case "cre": // création d'un nouvel objet
			...
			<tr>
				...
				<td><input type="text" name="gobj_chance_drop_monstre">&nbsp; <em style="font-size: 9px;">à n'utiliser que si l'objet a 100% de chance d'être possèdé par le monstre</em></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><select name="gobj_desequipable"><option value="O">Oui</option><option value="N">Non</option></select></td>
			</tr>			<tr>
		...
		case "mod2":
            ...
            <tr>
                <td class="soustitre2">Chance de drop à la mort du monstre (en %)</td>
                <td><input type="text" name="gobj_chance_drop_monstre" value="<?php echo $db->f("gobj_chance_drop_monstre");?>">&nbsp; <em style="font-size: 9px;">à n'utiliser que si l'objet a 100% de chance d'être possèdé par le monstre</em></td>
            </tr>
			<tr>
				<td class="soustitre2">Chance d’avoir un objet enchantable (en %)</td>
			...
			<tr>
				<td class="soustitre2">Objet déséquipable (O: oui ; N: non)</td>
				<td><input type="text" name="gobj_desequipable" value="<?php echo $db->f("gobj_desequipable");?>"></td>
			</tr>
			<tr>
