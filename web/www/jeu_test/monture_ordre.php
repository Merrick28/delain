...
if ($perso->perso_type_perso == 3){
    ...
    $contenu_page .= '<div style="font-size: 10px;">&nbsp;&nbsp;<div style="display:inline-block;" class="horseBlink"><div class="pasvu caseVue" title=""><img src="/images/del.gif" width="28" height="28" alt=""></div></div> = Terrain innacessible avec votre monture.</div>';
