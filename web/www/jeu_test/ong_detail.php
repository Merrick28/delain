<form name="det_cadre" method="post" action="frame_vue.php">
    ...
    $db->next_record();
    ?>
    <div class="centrer"><?php echo $db->f("pos_x"); ?>, <?php echo $db->f("pos_y"); ?>
        , <?php echo $db->f("etage_libelle"); ?><br>
		...
		order by minusc";
                ...
                <td class="soustitre2" valign="top"><strong><?php echo $db->nf(); ?> monstres : </strong><br>
                    <?php
                    if ($db->nf() != 0)
                    {
                        while ($db->next_record())
