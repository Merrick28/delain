...
function tag_perso($pnj, $type_perso, $actif)
{
	...
	switch ($pnj)
	{
		case 0: $txt_pnj = 'standard'; break;
		case 1: $txt_pnj = 'pnj'; break;
		case 2: $txt_pnj = '4ème perso'; break;
		default: $txt_pnj = 'inconnu'; break;
	}
	switch ($type_perso)
	{
		case 1: $txt_perso = 'aventurier'; break;
		case 2: $txt_perso = 'monstre'; break;
		case 3: $txt_perso = 'familier'; break;
		default: $txt_perso = 'inconnu'; break;
	}
...
if ($droit['controle'] == 'O' && $vcompte != -1)
{
	...
	{ ?>
		<tr><td class="soustitre2"><?php  echo $db->f('timestamp'); ?></td>
			<td class="soustitre2"><?php  echo $db->f('icompt_compt_ip'); ?></td></tr>
	<?php  } ?>
	</table>
	<?php 
	if ($compt_conf != 'O')
