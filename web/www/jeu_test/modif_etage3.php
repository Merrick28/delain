	...
	switch ($methode)
	{
		case "creer_etage":
			...
			if($erreur == 0)
			{
				...
				$req = "insert into etage (etage_cod, etage_numero, etage_libelle, etage_reference, etage_description,
						etage_affichage, etage_arene, etage_familier_actif, etage_quatrieme_perso,etage_mort_speciale, etage_mort, etage_retour_rune_monstre,
		...
		case "modifier_etage":
			...
			if($erreur == 0)
			{
				...
				$req_avant = "select etage_libelle, etage_description, etage_affichage, etage_arene, etage_familier_actif, etage_quatrieme_perso, etage_quatrieme_mortel, etage_mort_speciale,
...
?>
	...
	?>
			...
			La mort a cet étage a-t-elle un comportement spécial ? <select name="etage_mort_speciale"><option value='0'>Normal</option><option value='1'>Course de monture</option></select><br /><br />
...
<?php 	}
	...
	if ($methode == 'début_modifier')
	{
		$req = "select etage_cod, etage_numero, etage_libelle, etage_reference, etage_description,
				etage_affichage, etage_arene, etage_quatrieme_perso, etage_quatrieme_mortel, etage_mort_speciale, etage_mort, etage_retour_rune_monstre,
...
?>
	...
	?>
            ...
            La mort a cet étage a-t-elle un comportement spécial ? <select name="etage_mort_speciale"><option value='0' <?php echo  $sel_mort_spec0; ?>>Normal</option><option value='1' <?php echo  $sel_mort_spec1; ?>>Course de monture</option></select><br /><br />
