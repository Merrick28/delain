    ...
    <div align="center">
        <div id="intro" class="tableau2">
            ...
            <p>Ceci est une page en cours de développement, ce qui veut principalement dire qu'elle ne fonctionne pas.
                Elle va changer, contenir des essais et des idées qui viendront plus ou moins vite (ou pas du tout).
                Mais vous pouvez faire des essais et des remarques si vous voulez.</p>
        ...
        <p style=text-align:left>
            <a href="javascript:document.message.submit();">Envoyer un message à tous les aventuriers présents dans le
                temple !</a><br>
        ...
        <p style=text-align:left>
            <a href="javascript:document.message2.submit();">Envoyer un message aux alentours du temple <em>(i.e. à 3
                    lieues)</em></a><br><em>Attention, il est prévue que cela consomme de la puissance de votre
                Dieu</em>
        <?php
        endPane();
        ...
        <form name="refuge" method="post" action="gere_temple4.php">
            ...
            <p style=text-align:left><strong><a href="javascript:document.refuge.submit();">Abandonner le statut de
                        refuge pour ce temple ? <em>(Cette fonctionnalité sera dorénavant controlée)</em></a></strong>
                <?php
                }
                ?><?php
                endPane();
