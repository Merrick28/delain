...
if ( $perso->monture_controlable() )
{
    ...
    $req_position_actuelle =
        "select pos_cod,pos_x,pos_y,perso_pa,pos_etage,perso_nom, vue_pre(perso_cod) as vue_pre from perso_position,positions,perso ";
    ...
    /* sur une monture à ordre, on ne peut pas se déplacer seul */
