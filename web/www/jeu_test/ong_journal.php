...
<table>
    ...
    echo("<hr>");
    echo '<div class="centrer"><a class="centrer" href="javascript:void(0);" onclick="getdata(\'' . $type_flux . G_URL . 'jeu_test/fr_dr.php?methode=ajout1&t_frdr=3\',\'vue_droite\')">Ajouter une entrée dans le journal.</a></div>';
    break;
    case "voir":
        ?>
            ...
            <table>
                <tr>
                    <td class="soustitre2" colspan="2">
                        ...
                        ?>
                <tr>
                    <td colspan="2"><p><?php /*echo bbcode_parse($BBHandler, $texte);*/
                        echo $texte; ?></td>
                </tr>
                <tr>
                    <td class="soustitre2">
                        <a href="javascript:void(0);"
                           onclick="getdata('<?php echo $type_flux . G_URL; ?>jeu_test/fr_dr.php?methode=modif1&journal_cod=<?php echo $journal_cod; ?>&t_frdr=<?php echo $t_frdr; ?>','vue_droite');">Modifier</a>
                    </td>
                    <td class="soustitre2">
                        <a href="javascript:void(0);"
                           onclick="getdata('<?php echo $type_flux . G_URL; ?>jeu_test/fr_dr.php?methode=effacer&journal_cod=<?php echo $journal_cod; ?>&t_frdr=<?php echo $t_frdr; ?>','vue_droite');">Effacer</a>
                    </td>
                </tr>
            </table>
        </form>
            ...
            <div class="centrer">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <noscript></noscript>
                            <input type="button" value="b" style="width:50px;font-weight:bold"
                                   onclick="storeCaret('b')">
                            <input type="button" value="i" style="width:50px;font-style:italic"
                                   onclick="storeCaret('i')">
                            <input type="button" value="u" style="width:50px;text-decoration:underline"
                                   onclick="storeCaret('u')">
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <input type="button" value="url" style="width:50px" onclick="storeCaret('url')">
                        <input type="button" value="img" style="width:50px" onclick="storeCaret('img')"><br/>
                        <textarea name="contenu" id="contenu" rows="10" wrap="virtual"
                                  cols="45"><?php echo $texte; ?></textarea>
                    </td>
    ...
    ?>
    <a href="javascript:void(0);"
       onclick="getdata('<?php echo $type_flux . G_URL; ?>jeu_test/fr_dr.php?t_frdr=<?php echo $t_frdr; ?>','vue_droite');">Retour
        au sommaire</a>
