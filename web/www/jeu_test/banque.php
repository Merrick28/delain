...
<p>Verser <input type="text" name="quantite" value="0" onChange="quantite_2.value=Math.ceil(0.0<?php echo $numero; ?>*quantite.value);quantite_3.value=Math.floor(0.9<?php echo (10-$numero); ?>*quantite.value);"> Br sur le compte:
        ...
        // TRAITEMENT: UN PERSONNAGE FAIT UN RETRAIT SUR SON COMPTE PERSONNEL
         ...
         // TRAITEMENT: UN PERSONNAGE FAIT UN DEPOT SUR LE COMPTE D'UNE GUILDE
                ...
                if($erreur == 0)
                {
                  ...
                  $db->next_record();
            	    ?>
            	     <p>Vous avez versé <?php echo $depot_guilde;?> Br sur le compte <?php echo $db->f("gbank_nom")?> (<?php echo $db->f("guilde_nom")?>), <BR\>
         ...
         if (($nb_guilde > 0) and ($adm == "O")){
            ...
            if ($erreur == 0)
            {
                  ...
                  $db->next_record();
            	    ?>
            	     <p>Vous venez de retirer <?php echo $quantite;?> Br à partir du compte <?php echo $db->f("gbank_nom")?> (<?php echo $db->f("guilde_nom")?>).
                   </p>
            	    <?php 
...
?>
  ...
  <input type="hidden" name="methode" value="creer_compte_guilde">
	...
	<p><center><input type="submit" value="Créer !" class="test"></center>
	</form>
<?php 
        }
