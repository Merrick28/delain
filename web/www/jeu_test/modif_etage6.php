...
?>
<br>En cliquant sur une case déjà remplie par une cachette, on peut modifier son contenu (cachette), ou si c’est un piège, les effets associés.<br>
En cliquant sur une case vide, deux choix sont proposés pour rajouter piège ou cachette<br><br>
<table><tr>
		<td width="20" height="20"><div style="width:25px;height:25px;background:#FFCCFF"></div></td><td>Présence d’une cachette</td>
		<td width="20" height="20"><div style="width:25px;height:25px;background:#663399"></div></td><td>Présence d’un piège</td>
		<td width="20" height="20"><div style="width:25px;height:25px;background:#C0C0C0"></div></td><td>Cachette et mur creusable</td>
		<td width="20" height="20"><div style="width:25px;height:25px;background:#FFCC00"></div></td><td>Piège et mur creusable</td>
		<td width="20" height="20"><div style="width:25px;height:25px;background:#FFFF99"></div></td><td>Fontaine de jouvence</td>
	</tr>
</table>
	<table border="1">
	<tr>
...
?>
	...
	<td width="20" height="20" ><div id="pos_<?php echo  $db->f("pos_cod");?>" style="width:25px;height:25px;background:<?php echo $color?>;" <?php echo $onclick?>><span style="font-size:10px;"><?php echo $texte;?></span></div></td>
<?php 
