...
<div class="liste_equipement ui-widget-content">
    ...
    <ul class="simplifie">
        <li class="head">
            <div class="li_nom">Nom</div>
            <div class="li_type">Type</div>
            <div class="li_nombre">Nombre</div>
            <div class="li_poids">Poids</div>
        </li>
        <?php for ($i = 1; $i < 6; $i++)
        {
            for ($j = 1; $j < $i + 2; $j++)
            {
                $nb = rand(1, 10);
                ?>
                <li><img class="li_img" alt="Rune" src="images/rune_<?php echo $i ?>_<?php echo $j ?>.gif">
                    <div class="li_nom">Male</div>
                    <div class="li_type">Rune</div>
                    <div class="li_nombre"><?php echo $nb ?></div>
                    <div class="li_poids"><?php echo $nb / 10.0 ?></div>
                    <div class="li_action"><a href="#">D&eacute;poser</a></div>
                </li>
            <?php }
        } ?>
        <li class="total">
            <div class="li_total">Total:</div>
            <div class="li_poids">10.0</div>
        </li>
    </ul>
