...
<style type="text/css">
	...
	.draggable { width: 50px; height: 50px; padding: 0.5em; float: left; margin: 10px; cursor:pointer;}
...
ul { list-style-type: none; margin: 0; padding: 0;  }
	...
	$(function() {
		...
		$(".draggable").draggable({ connectToSortable: '#sortable', 
			revert: 'invalid', 
