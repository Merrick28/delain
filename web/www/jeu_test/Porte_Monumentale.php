...
if ($erreur == 0)
{
    ...
    switch ($methode)
    {
        ...
        case "debut":
            ?>
            <p>
                <img src="../images/batadmin.gif" alt="Bâtiment administratif"><strong><?php echo($tab_lieu['nom'] . '</strong> - ' . $tab_lieu['description']); ?>
            <p>Bonjour,<br>
...
<tr>
    <td height="10" width="10" background="<?php echo G_IMAGES ?>coin_bg.gif"><img src="<?php echo G_IMAGES ?>del.gif"
                                                                                   height="2"></td>
