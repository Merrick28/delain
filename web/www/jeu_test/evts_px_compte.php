    ...
    <table cellspacing="2">
        ...
        <form name="visu_evt" method="post" action="evts_px_compte.php">
            ...
            while ($result = $stmt->fetch()) {
                echo("<tr>");
                printf("<td class=\"soustitre3\"><p>%s</p></td>", $result['evt_date']);
                printf("<td class=\"soustitre3\"><p><strong>%s</strong></p></td>", $result['tevt_libelle']);
                ...
                $req_nom_evt = $req_nom_evt . " where perso1.perso_cod = " . $result['levt_perso_cod1'] . " ";
                if ($result['levt_attaquant'] != '') {
                    $req_nom_evt = $req_nom_evt . " and attaquant.perso_cod = " . $result['levt_attaquant'] . " ";
                }
                if ($result['levt_cible'] != '') {
                    $req_nom_evt = $req_nom_evt . " and cible.perso_cod = " . $result['levt_cible'] . " ";
                }
