...
<?php 			$req = 'select enc_cod,enc_nom,enc_description from enchantements order by enc_nom ';
		...
		case "modif":
			...
			$db->next_record();
			?>
			<a href="<?php echo $PHP_SELF;?>?methode=serie_obj&enc=<?php echo $enc;?>">Modifier la liste d'objets</a><br>
			<a href="<?php echo $PHP_SELF;?>?methode=compat&enc=<?php echo $enc;?>">Modifier les compatibilités</a><br>
			<table>
			<form name="ajout" method="post" action="<?php echo $PHP_SELF;?>">
			...
			<input type="hidden" name="enc" value="<?php echo $enc;?>">
				...
				<tr>
					<td class="soustitre2">Description</td>
					<td><textarea cols="50" rows="10" name="description"><?php echo $db->f('enc_description');?></textarea></td>
				</tr>
				<tr>
					<td class="soustitre2">Cout en brouzoufs</td>
				...
				<tr>
					<td class="soustitre2">Bonus vampirisme (réél)</td>
					<td><input type="text" name="enc_vampirisme" value="<?php echo $db->f('enc_vampirisme');?>"></td>
				</tr>
				<tr>
					<td class="soustitre2">Bonus régénération (entier)</td>
				...
				<tr>
					<td class="soustitre2">Bonus seuil force (entier)</td>
					<td><input type="text" name="enc_seuil_force" value="<?php echo $db->f('enc_seuil_force');?>"></td>
				</tr>
				<tr>
					<td class="soustitre2">Bonus seuil dextérité (entier)</td>
				...
				<tr>
					<td class="soustitre2">Bonus chance drop (réél, multiplicateur)</td>
					<td><input type="text" name="enc_chance_drop" value="<?php echo $db->f('enc_chance_drop');?>"></td>
				</tr>
				<tr>
					<td class="soustitre2">Bonus poids (réél, multiplicateur)</td>
		...
		case "compat":
			...
			Entrez les types d'objets pour lequel cet enchantement sera disponible (1 = disponible, 0 = non disponible).<br>
			<table>
				<tr>
					<td class="soustitre2">Arme de contact</td>
					<td><input type="text" name="tenc_arme_contact" value="<?php echo $db->f("tenc_arme_contact");?>"></td>
				</tr>
				<tr>
					<td class="soustitre2">Arme à distance</td>
					<td><input type="text" name="tenc_arme_distance" value="<?php echo $db->f("tenc_arme_distance");?>"></td>
				</tr>
				<tr>
