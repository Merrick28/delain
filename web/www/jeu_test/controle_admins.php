...
if ($droit['controle_admin'] == 'O')
{
	switch($methode)
	{
		...
		case "et2":
			...
			{
				?>
				<div align="left"><a href="javascript:document.controle.evt_start.value=<?php echo $evt_start;?>-50;document.controle.submit();"><== Précédent</a></div>
				<?php 
			}
			?>
			</td><td colspan="2"></td>
			<td>
			<td><div align="right"><a href="javascript:document.controle.evt_start.value=<?php echo $evt_start;?>+50;document.controle.submit();">Suivant ==></a></div>
			</td>
			</table>
			</center>
			</form>
