...
switch($methode)
{
	...
	case "tout":
		...
		echo "<input type=\"hidden\" name=\"compt_cod\" value=\"$compt_cod\">";
		echo "<input type=\"hidden\" name=\"idsessadm\" value=\"$compt_cod\">";
		$req = "select perso_cod,perso_nom,to_char(perso_dlt,'DD/MM/YYYY hh24:mi:ss'),compt_nom from perso,perso_compte,compte where perso_type_perso = 1 and perso_actif = 'O' ";
...
<input type="button" class="test" value="Rechercher un perso !" onClick="javascript:window.open('http://www.jdr-delain.net/rech_perso.php','rech','width=500,height=300');">		
<br><br>
<p style="text-align:center"><a href="http://www.jdr-delain.net/jeu_test/change_pass.php">Changer de mot de passe !</a><br />
