...
if ($erreur == 0)
{
	switch($methode)
	{
		case "entree":
			...
			- Le sort drain vampirique (6PA - contact) fait 1D10 de dégats à une cible, et les points effectués sont rajoutés au PV du vampire (jusqu'à la limite de ses PV max)<br>
