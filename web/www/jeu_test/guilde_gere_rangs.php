...
if ($db->is_admin_guilde($perso_cod))
{
	...
	switch($methode)
	{
	 	case "debut":
	 		...
	 		echo "</table>";
	 		echo "<p style=\"text-align:center\"><a href=\"guilde_gere_rangs.php?methode=ajout\">Ajouter un nouveau rang ?</a>";
	 		break;	
	 	case "ajout":
	 		?>
		 ...
		 case "ajout2":
			...
			$nom = pg_escape_string($nom);
	 		...
	 		echo "<p style=\"text-align:center\"><a href=\"guilde_gere_rangs.php\">Retour à la gestion des rangs</a>";
		 	break;
		 case "modif":
