...
if(!isset($methode))
	...
	switch($methode)
	{
		...
		<br><a href="<?php echo $PHP_SELF;?>?methode=quitte">Oui</a>, laissez-moi partir, ils se débrouilleront bien mieux sans moi !
		<br><br><a href="http://www.jdr-delain.net/jeu/guilde.php">Non</a>, c'était une erreur, je me sens bien dans cette guilde.	
		<?php 
		break;
		case "quitte":
