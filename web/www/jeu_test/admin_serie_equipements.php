...
Chances sans objet:<input type="text" name="seequ_proba_sans_objet" value="<?php  echo $db->f("seequ_proba_sans_objet")?>">
...
<td><input type="text" name="seequo_etat_min" value="<?php echo $db2->f("seequo_etat_min");?>"></td>
<td><input type="text" name="seequo_etat_max" value="<?php echo $db2->f("seequo_etat_max");?>"></td>
