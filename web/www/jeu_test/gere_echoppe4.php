...
if ($erreur == 0)
{
	...
	switch($methode)
	{
		case "debut":
			...
			{
				echo "<tr>";
				echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><b><a href=\"gere_echoppe4.php?mag=$mag&methode=mod\">Modifier ces données</a></b></td>";
				echo "</tr>";
				
				echo "<tr>";
				echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><b><a href=\"gere_echoppe4.php?mag=$mag&methode=nom\">Changer le nom et la description</a></b></td>";
				echo "</tr>";
				
				echo "<tr>";
				echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><b><a href=\"gere_echoppe4.php?mag=$mag&methode=vente_adm\">Vendre du matériel à l'administration</a></b></td>";
				echo "</tr>";
				
				echo "<tr>";
				echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><b><a href=\"gere_echoppe4.php?mag=$mag&methode=achat_adm\">Acheter du matériel à l'administration</a></b></td>";
				echo "</tr>";
				
				echo "<tr>";
				echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><b><a href=\"gere_echoppe4.php?mag=$mag&methode=fix_prix\">Fixer les tarifs</a></b></td>";
				echo "</tr>";
				
				echo "<tr>";
				echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><b><a href=\"gere_echoppe4.php?mag=$mag&methode=stats\">Voir les stats</a></b></td>";
				echo "</tr>";
			}
