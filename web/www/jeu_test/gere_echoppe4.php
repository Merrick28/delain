...
if ($erreur == 0) {
    ...
    switch ($methode) {
        case "debut":
            ...
            if ($modif_possible == 1) {
                echo "<tr>";
                echo "<td colspan=\"2\" class=\"soustitre2\"><strong><a class='centrer' href=\"gere_echoppe4.php?mag=$mag&methode=mod\">Modifier ces données</a></strong></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td colspan=\"2\" class=\"soustitre2\"><strong><a class='centrer' href=\"gere_echoppe4.php?mag=$mag&methode=nom\">Changer le nom et la description</a></strong></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td colspan=\"2\" class=\"soustitre2\"><strong><a class='centrer' href=\"gere_echoppe4.php?mag=$mag&methode=vente_adm\">Vendre du matériel à l'administration</a></strong></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td colspan=\"2\" class=\"soustitre2\"><strong><a class='centrer' href=\"gere_echoppe4.php?mag=$mag&methode=achat_adm\">Acheter du matériel à l'administration</a></strong></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td colspan=\"2\" class=\"soustitre2\"><strong><a class='centrer' href=\"gere_echoppe4.php?mag=$mag&methode=fix_prix\">Fixer les tarifs</a></strong></td>";
                echo "</tr>";

                echo "<tr>";
                echo "<td colspan=\"2\" class=\"soustitre2\"><strong><a class='centrer' href=\"gere_echoppe4.php?mag=$mag&methode=stats\">Voir les stats</a></strong></td>";
                echo "</tr>";
            }
