        ...
        case 'objet':
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" size="5" name="obj_distance" value="<?php echo $db->f('obj_distance'); ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" size="5" name="obj_vampire" value="<?php echo $db->f('obj_vampire'); ?>">
                    </td>
                </tr>
                <tr>
                    <td class="soustitre2">Aura de feu :</td>
                    <td><input type="text" size="5" name="obj_aura_feu" value="<?php echo $db->f('obj_aura_feu'); ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" size="5" name="obj_chance_drop"
                               value="<?php echo $db->f('obj_chance_drop'); ?>"></td>
                </tr>
                <tr>
