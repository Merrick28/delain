                ...
                foreach ($types as $e => $type)
                {
                    ...
                    if ((!isset($_REQUEST["element_type"][$param_id])) || ($_REQUEST["element_type"][$param_id] == $type))
                    {
                        ...
                        $element->aqelem_param_num_1 =
                            isset($_REQUEST["aqelem_param_num_1"][$param_id][$e]) ? 1 * $_REQUEST["aqelem_param_num_1"][$param_id][$e] : NULL;
                        $element->aqelem_param_num_2 =
                            isset($_REQUEST["aqelem_param_num_2"][$param_id][$e]) ? 1 * $_REQUEST['aqelem_param_num_2'][$param_id][$e] : NULL;
                        $element->aqelem_param_num_3 =
                            isset($_REQUEST["aqelem_param_num_3"][$param_id][$e]) ? 1 * $_REQUEST['aqelem_param_num_3'][$param_id][$e] : NULL;
