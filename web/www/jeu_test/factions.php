...
else
{
	...
	switch ($methode)
	{
		...
		case 'amende_honorable':	// Démission validée
			...
			{
				$message = "Et en plus il se moque de nous... Vous n’avez pas le début de la somme demandée ! Barrez-vous ou j’appelle les gardes.<br />";
			}
			$pfac_statut = 0;
		break;
	...
	if ($pfac_statut == 0)	// Le gars n’est pas démissionnaire
	{
		...
		$tableauMission = $db->missions_du_perso($perso_cod, $faction);
