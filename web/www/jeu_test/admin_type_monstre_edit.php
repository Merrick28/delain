        ...
        case "edit":// MODIFICATION DE MONSTRE GENERIQUE EXISTANT
            if ($sel_method == "edit" or $sel_method == "new_from")
            {
                ...
                $req_gmon    = "select gmon_cod,gmon_nom"
                        ...
                        . ",gmon_nb_receptacle,gmon_type_ia,gmon_quete,gmon_duree_vie,gmon_voie_magique,gmon_sex, gmon_monture"
                    ...
                    <TABLE width="80%" align="center">
                        ...
                        <TR>
                            <TD><?php
                                ...
                                if ($sel_method == "edit" && !empty($arme) && $arme != "null")
                                {
                                    echo "<a href=\"admin_objet_generique_edit.php?methode=mod2&gobj_cod={$arme}\" target=\"_blank\">Arme</a>";
                                } else
                                {
                                    echo "Arme";
                                }
                            ...
                            <TD><?php
                                ...
                                if ($sel_method == "edit" && !empty($armure) && $armure != "null")
                                {
                                    echo "<a href=\"admin_objet_generique_edit.php?methode=mod2&gobj_cod={$armure}\" target=\"_blank\">Armure</a>";
                                } else
                                {
                                    echo "Armure";
                                }
                        ...
                        <TR>
                            <TD>Le monstre est une monture (O ou N)?</TD>
                            <TD>
                                <INPUT type="text" name="gmon_monture" value="<?php echo $result['gmon_monture']; ?>">
                            </TD>
                            <TD colspan="2">
                                Si le monstre est une monture, pensez à lui mettre un type d'IA spécique aux montures !
                            </TD>
                        </TR>
                        <TR>
                ...
                <?php if ($sel_method == "edit")
            {
                ...
                <div style="text-align:left; position:sticky; top:0; z-index:100; padding:10px; background:aquamarine; margin-bottom:15px;">
                    <strong><a href="#section_carac_base" style="color:inherit; text-decoration:underline;"><?php echo htmlspecialchars($gmon_nom); ?> (N°<?php echo $gmon_cod; ?>)</a> :</strong>
                        ...
                        <form method="post" action="admin_type_monstre_edit.php#section_monture">
                            ...
                            <TD>
                                ...
                                <select name="ter_cod[]" multiple size="8">
                                    ...
                                    {
                                        ?>
                                        <option value="<?php echo $result_m_terrain['ter_cod'] ?>"><?php echo $result_m_terrain['ter_nom'] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
