...
if ($erreur == 0)
{
    ...
    if (($style=="") && (isset($_REQUEST["supprimer_fond"]) || isset($_REQUEST["nouveau_fond"]) || isset($_REQUEST["supprimer_mur"]) || isset($_REQUEST["nouveau_mur"])))
    {
    ...
    if (isset($_REQUEST["supprimer_fond"]) && ($style!=""))
    {
        ...
        {
            //  vérification vérification que le fond n'es pas utilisé dans les étages avant de le supprimer
    ...
    if (isset($_REQUEST["supprimer_mur"]) && ($style!=""))
    {
        ...
        {
            //  vérification vérification que le mur n'es pas utilisé dans les étages avant de le supprimer
