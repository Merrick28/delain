...
?>
<tr><td class="titre"><p class="titre">Utilisation des PA restants</p></td></tr>
<tr><td><p>
<?php 
...
<!-- CONCENTRATION -->
<tr><td class="titre"><p class="titre">Concentration</p></td></tr>
<tr><td>
<?php 
...
<!-- COMBAT -->
<tr><td class="titre"><p class="titre">Combat</p></td></tr>
<?php 
...
?>
<tr><td><p style="text-align:center;"><?php  echo $combat;?></td></tr>
<?php 
...
<!-- BANQUE -->
<tr><td class="titre"><p class="titre">Banque</p></td></tr>
<tr><td><p>Vous avez <?php  echo $qte_or; ?> brouzoufs à la banque.</td></tr>
<!-- TEMPLE -->
<tr><td class="titre"><p class="titre">Temple choisi</p></td></tr>
<?php 
