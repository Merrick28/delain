    ...
    switch ($methode) {
        ...
        case "fix_prix":
            ...
            while ($result = $stmt->fetch()) {
                ...
                echo "<td><a href=\"gere_echoppe2.php?mag=$mag&methode=fix_prix2&gobj=" . $result['gobj_cod'] . "\">Modifier !</a></td>";
                echo "</tr>";
            }
            echo "<tr>";
            echo "<td colspan=\"5\"><input type=\"submit\" value=\"Valider les achats !\" class=\"test centrer\"></td>";
        ...
        case "fix_prix3":
            ...
            if ($annul == 'n') {
                ...
                if ($erreur == 0) {
                    ...
                    $stmt = $pdo->query($req);
                    $req = "insert into magasin_tarif  (mtar_lieu_cod,mtar_gobj_cod,mtar_prix) values  ($mag,$gobj,$n_prix) ";
                    $stmt = $pdo->query($req);
