	...
	switch($methode)
	{
		...
		case "cree1":
			...
			if ($erreur == 0)
			{
				...
				<tr><td colspan="2"><p>Le perso recevra un message contenant votre texte, ainsi qu'un lien pour valider ou refuser votre proposition</td></tr>
				<tr><td colspan="2"><p style="text-align:center;"><input type="submit" class="test" value="Valider l'envoi"></td></tr>
