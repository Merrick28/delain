...
<tr><td colspan="9" class="soustitre"><div class="soustitre">Aventuriers</div></td></tr>
<tr><td colspan="9" class="soustitre2">Afficher/masquer : <span style="cursor:pointer;" onclick="afficheMasque(contient, new Array(1, 'guilde.gif'), 'tablePersos', affichePersosCoterie); affichePersosCoterie = !affichePersosCoterie;">la coterie</span>.</td></tr>
<?php  if ($marquerQuatriemes) echo '<tr><td colspan="9" class="soustitre2"><i>Une astérisque * à côté du O de 4ème perso signifie que toute mort sera définitive pour ce personnage</td></tr>'; ?>
<tr>
<td class="soustitre2" width="50"><b>Dist.</b></td>
<?php  if ($marquerQuatriemes) echo '<td class="soustitre2"><b>4ème</b></td>'; ?>
