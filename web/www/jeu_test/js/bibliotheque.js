...
*@notice: � placer apres l'insertion de la biblioth�que JQuery
*/
...
{
	/* if typeof... => pour v�rifier que l'objet existe, */
...
function affiche_fiche_equipement($elem)
{
	...
	var $titre_degats="D�gats";
	var $titre_dexterite="Dext�rit�";
	var $titre_force="Force";
	var $titre_chute="Chute";
	var $titre_armure="Armure";
	var $titre_competence="Comp�tence";
	
	var $titre_critique="Protection contre les critique/sp�ciaux";
	var $titre_bonus_vue="Modificateur de vue";
	var $titre_vampirisme="Vampirisme";
	var $titre_aura_de_feu="Aura de feu";
	var $titre_regen="Bonus � la r�g�n�ration";
	var $titre_poison="D�g�ts inflig�s par poison";
	...
	var $titre_deposable="Non d�posable !";
	*/
	...
	{
		$regen = $($elem).attr('regen')+" � l'initialisation de DLT";
	...
	if ( isExist($($elem).attr('deposable')) ) 
		$deposable = ($($elem).attr('deposable')==1)?"Non D�posable!":"";
	else $deposable = "";
...
* 
* Affiche la fiche de l'item que l'on a selectionn�
* 
**/
...
* (gestion de Abandon, Identifier, R�parer)
* 
**/
