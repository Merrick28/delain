...
{
    ?>
    <p><em>Vous vous trouvez dans une vaste salle entourée d’arcades élégantes. Sous ces arcades se cachent des alcôves
            contenant des lits. Des aventuriers de tous horizons reposent dans certaines de ces alcôves, les bandages
            qui entourent leur tête ou leurs membres indiquent qu’ils ont été récemment blessés. Un escalier conduit à
            ...
            <br>
            L’humain si bien musclé se place juste devant vous, et baisse son visage aux traits énergiques vers vous. Il
    ...
    <p><input type="radio" name="soins" value="1" checked>Vous montrez les menues blessures qui ornent votre corps : «
        ...
        <input type="radio" name="soins" value="2">Vous dévoilez une large plaie qui vous fait souffrir : « Pouvez-vous
        soigner cette blessure ? » - 35 brouzoufs.<br/>
        <input type="radio" name="soins" value="3">Dans un souffle, vous murmurez « J’agonise... sauvez-moi... » - 60
        brouzoufs.<br/>
...
<?php } else
{
    ...
    <p><em> Vous vous trouvez dans une vaste salle entourée d’arcades élégantes.
            ...
            dans certaines de ces alcôves, les bandages qui entourent leur tête ou leurs membres indiquent qu’ils ont
            été
            ...
            Son corsage étroit épouse les formes voluptueuses de son corps. Dans le creux de son décolleté aux formes
            épanouies se love un pendentif en or.
            Vos yeux s’attardant à cet endroit, vous remarquez que le pendentif à la forme d’un calice, symbole de sa
            fonction de guérisseuse.
            Arrivée à côté de vous, la sublime jeune femme plonge dans votre regard ses yeux azurés, dont la vivacité
            est tempérée par le rideau de ses cils allongés. La suavité de sa voix s’écoule alors de sa bouche coralline
            vers vous :
            <br>
