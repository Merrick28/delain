...
if ($methode=="")
{
    ...
    if (!isset($_REQUEST["onglet"]))
    {
        ...
        else
        {
            ...
            $contenu_page2 .= "Quête commencée le : ".date("d/m/Y H:i:s", strtotime($quete_perso->aqperso_date_debut)) ."&nbsp;&nbsp;(<em style=\"font-size:9px;\"><a href={$link}>Arrêter cette quête</a></em>)<br>" ;
