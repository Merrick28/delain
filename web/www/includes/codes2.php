...
<td class=\"soustitre2\" width='$colwidth1'><p>$police&nbsp;$smiley1</center></td><td class=\"soustitre2\" width='$colwidth1'><center><a href=\"javascript:emoticon('" , $smiley1 , "')\">"; print(binettes("$smiley1")); echo "</A></center></td>
<td class=\"soustitre2\" width='$colwidth1'><p>$police&nbsp;$smiley2</center></td><td class=\"soustitre2\" width='$colwidth1'><center><a href=\"javascript:emoticon('" , $smiley2 , "')\">"; print(binettes("$smiley2")); echo "</a></center></td>
</tr>";
}
...
require("params.php");
echo "<tr bgcolor='$bgcont'>
<td width='$colwidth' colspan='2'>$police&nbsp;$smiley1</center></td><td width='$colwidth' colspan='2'><center>"; print(binettes("$smiley1")); echo "</center></td>
</tr>";
}


echo "<body background=\"../images/fond5.gif\"><center>";
...
?>
<center><input type="button" onClick="javascript:window.close()" class="test" value="Fermer">
<?php 
