...
<div class="centre1" id="Centre1">
    <table class="interview" cellspacing="4">
      <tr>
        <td colspan="4" class="interview_titre">L'INTERVIEW DE LA SEMAINE : <br>
          LE MERCENAIRE.
		</td>
      </tr>
      <tr>
        <td colspan="4" class="interview_intro">
Bardamu arrive, ses bras enroulant deux tonneaux. Il se baisse, laisse rouler un des tonneaux aux pieds de son invité, et escalade l’autre afin de s’y installer. Sa main restera crispée sur son son épée durant tout l’entretien…
[Pour les besoins de la mise en page, cette interview n'a pu être diffusée dans son intégralité.]
		</td>
      </tr>
      <tr>
...
<br><b>Bardamu</b> : *œil noir pointé sur Kaali*
...
<div class="droite1" id="Droite1">
	<table class="edito">
          ...
          <tr class="edito_corps">
            <td>
		       Les t&eacute;n&egrave;bres &eacute;tendent leur ombre sur les souterrains. <br>
		       Quelque soit l'&eacute;tage, le Mal &eacute;treint les &acirc;mes. Certains ont succomb&eacute; aux charmes sombres d&egrave;s le berceau, d'autres ont embrass&eacute; l'obscurit&eacute; apr&egrave;s avoir combattu aux c&ocirc;t&eacute;s des vaillants. <br>
		       Ainsi, Kaali et sa meute de sauvageons &eacute;tripent du gros au &ndash;5, qu'il n'est plus n&eacute;cessaire de nommer l'Antichambre de l'enfer&quot;, mais juste l'&quot;Enfer&quot; &hellip; <br>
		       Puis, au milieu de ces aventuriers zigouilleurs, &eacute;mergent une race nouvelle et &eacute;tonnante: des monstres qui se rangent du c&ocirc;t&eacute; du Bien, &eacute;cartelant leurs fr&egrave;res. <br>
		       Rebelles, ils se lib&egrave;rent des filets &quot;malkiaresques&quot;, et cheminent aux c&ocirc;t&eacute;s de valeureux guerriers. <br>
		       Bon&hellip; Leur &eacute;locution est douteuse, mais le c&oelig;ur y est ! <br>
  	           En conclusion, la folie semble avoir p&eacute;n&eacute;tr&eacute; les profondeurs, d&eacute;tournant chacun de son destin initial... 
            </td>
          </tr>
    </table>
</div>
...
<div class="gauche2" id="Gauche2">
	<table class="interview" cellspacing="4">
      <tr>
        <td colspan="3" class="interview_titre">INTERVIEW<br>
PAPOTAGE AVEC NERLASH
		</td>
      </tr>
      <tr>
...
Les Nyouzes des Souterrains.
      ...
      <tr>
        <td class="horoscope_intro">
La gazette ouvre ses colonnes dans une atmosphère plutôt sereine. Les Snorkys et les Farfadets semblent avoir disparu, précédant la chute de Kaali. Le fanatique religieux, Mercenaire recyclé en adorateur de Balgur, a fini de terroriser l'Antichambre des Enfers. Lui et ses amis se sont fait botter les fesses par le Fight Club, un nouveau groupe qui démarre fort!
        </td>
	  </tr>
      <tr>
        <td class="horoscope_intro">
<br>Coté politique, c'est le remue-ménage chez les Chevalier de Justice :  un quart des troupes a fait sécession et créé  " Les croisés de Falis ". Un simple problème de communication qui révèle peut-être des cicatrices plus profondes, la tête de la guilde étant trop occupée, tournée vers la MdM et Délia, le prétendu enfant de la Déesse Falis. Quand à Ecate, sa jumelle maléfique, elle se fait discrète ces temps-ci.
        </td>
	  </tr>
      <tr>
        <td class="horoscope_intro">
<br>Quant au sombre Malkiar, il a laissé un goût amer dans la bouche de bon nombre d'aventuriers... L'invocation d'un de ses sbires par l'Archidiacre Siméon a mal tourné ! Le démon Klatroellezül s'est libéré des chaînes créées par ce dernier et a laissé le vieillard au bord de la mort. Son toupet est aller jusqu'à semer la zizanie chez les aventuriers en poussant Sanguin, ancien dirigeant de la Caravane à étriper Liselle, pilier de l'Escorte de l'archidiacre. Le démon aurait de plus emporté un mystérieux ouvrage appartenant à cette dernière.
        </td>
	  </tr>
    </table>
</div>
...
<div class="centre3" id="Centre3">
	<table class="pub">
      ...
      <tr class="pub_corps">
        <td width="196px">
		  A vous les cuites dans les tavernes humaines! Faussaire tr&egrave;s dou&eacute; vends faux papiers d'identit&eacute; pour d&eacute;mons mineurs, contacter la gazette qui fera suivre. Petits malins ou ancien responsable de la milice, s'abstenir.
		</td>
        <td width="192px">
  ...
  <table class="musique">
    <tr class="musique_corps">
	  <td class="musique_titre">
		...
		<a href="mailto:lavoixdessouterrains@ifrance.com">La Voix des Souterrains</a>
      </td>
	</tr>
  </table>
</div>
...
<div class="droite3" id="Droite3">
	<table class="annonce">
      ...
      <tr class="annonce_corps">
		...
		<td>
		   Recherche rédacteurs n'ayant pas froid aux yeux pour cause renouvellement suite accidents malencontreux avec démons mineurs, rédactrice en chef en colère et metteur en page furieux.
