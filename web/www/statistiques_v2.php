...
$req_halloween = "select perso_nom, count(*) as nb_bonbon from public.perso_objets 
                    ...
                    where obj_gobj_cod=1672 and (perso_type_perso=1 or perso_type_perso=3) and perso_pnj != 1
                    group by perso_nom
                    having count(*) >= (
