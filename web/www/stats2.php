...
<link rel="stylesheet" type="text/css" href="style.css" title="essai">
	...
	<table background="images/fondmarchemin.gif" bgcolor="#EBE7E7" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			$req_joueur = "select count(perso_cod) as nb from perso where perso_type_perso = 1 and perso_actif != 'N' ";
			$db->query($req_joueur);
			$db->next_record();
			$nb_joueur = $db->f("nb");
		...
		<tr>
			<td background="images/ligne_gauche.gif">&nbsp;</td>
			<td><p><a href="http://www.jdr-delain.net/cgi-bin/awstats.pl?config=jdr-delain" target="_blank">Statistiques du site web</a>
			</td>
			<td background="images/ligne_droite.gif">&nbsp;</td>
			</td>
		</tr>
			...
			<tr>
			<td background="images/ligne_gauche.gif">&nbsp;</td>
			<td class="titre"><p class="titre">Statistiques des joueurs :
			</td>
			<td background="images/ligne_droite.gif">&nbsp;</td>
			</td>
		</tr>
			...
			$req_niveau = $req_niveau . "where perso_actif != 'N' and perso_type_perso = 1 ";
			...
			echo("<tr><td class=\"soustitre2\"><p>Niveau :</td><td class=\"soustitre2\"><p>Nombre de persos :</td></tr>");
			...
			$req = $req . "from race where race_cod in (1,2,3,32,33,34,35) ";
			$db->query($req);
			echo("<table cellspacing=\"2\" cellpadding=\"2\">");
			...
			echo("<table cellspacing=\"2\" cellpadding=\"2\">");
			echo("<tr><td class=\"soustitre2\" colspan=\"3\"><p style=\"text-align:center;\">Répartition par étage :</td></tr>");
			echo("<tr><td class=\"soustitre2\"><p>Etage</td><td class=\"soustitre2\"><p>Joueurs</td><td class=\"soustitre2\"><p>Monstres</td></tr>");
			...
			$req = $req . "and perso_actif != 'N') as joueur, ";
			$req = $req . "(select count(perso_cod) from perso,perso_position,positions ";
			$req = $req . "where pos_etage = etage_numero ";
			$req = $req . "and ppos_pos_cod = pos_cod ";
			$req = $req . "and ppos_perso_cod = perso_cod ";
			$req = $req . "and perso_type_perso = 2 ";
			$req = $req . "and perso_actif != 'N') as monstre ";
			$req = $req . "from etage ";
			...
			while ($db->next_record())
			{
				echo "<tr><td class=\"soustitre2\"><p>" . $db->f("etage_libelle") . "</p></td><td><p>" . $db->f("joueur") . "</td><td><p>" . $db->f("monstre") . "</td></tr>";
			}
