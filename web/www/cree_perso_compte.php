            ...
            <div class="centrer">
                <table background="images/fondparchemin.gif" width="80%" bgcolor="#EBE7E7" border="0" cellpadding="2"
                    ...
                    <?php if ($creation_4e)
                    {
                        ...
                        <tr>
                            <td colspan="3">
                                Vous avez la possibilité de créer ce personnage car vous êtes présent sur le jeu depuis
                                plus
                                de
                                deux ans.<br/>
                                ...
                                <strong>Il ne pourra pas se rendre en dessous du -1. Ce qui correspond à l’heure
                                    actuelle
                                    aux
                                    étages 0, -1, -1 bis et sous bassements et découvertes ainsi que le passage sous la
                                    rivière.</strong>
                                De plus, il est fort possible qu’il soit aussi limité en terme de niveau
                                d’expérience.<br/>
                                Si ces règles ne vous conviennent pas, ne gardez surtout pas ce personnage, car ne pas
                                les
                                respecter sera forcément sanctionné !<br/>
                                <br/>
                                Comprenez aussi que ce personnage n’est pas là pour vous fournir un avantage en terme de
                                jeu,
                                mais plus pour vous permettre d’aider d’autres aventuriers.
                                Dans le cas où nous aurions à gérer la moindre plainte (accaparement de matériel,
                                menaces,
                                4°
                                personnage d’une triplette ...), la sanction sera immédiate et ne touchera pas que ce
                                personnage.
                                Nous comptons sur votre fair play et que cela vous permette de découvrir une nouvelle
                                dimension
                                du jeu. <br/>
                                <br/>
                                <strong>Pour une expérience de jeu encore différente, il est également possible de
                                    contrôler
                                    un
                                    monstre !</strong> Pour activer cette option, rendez-vous dans les options de votre
                                compte,
                    ...
                    <tr>
                        <td colspan="3"><strong>Avant de créer votre personnage, nous vous invitons à consulter les <a
                                ...
                                donneront tout un tas d’informations utiles sur les fiches de personnage, ainsi que le
                                <a
                                        href="http://www.jdr-delain.net/wiki/index.php">wiki</a> en général, qui
                                contient de
                                très nombreuses informations.<br>De plus <a
                                        href="http://www.jdr-delain.net/doc/aide.php">une
                                    aide à la création des personnages</a> est disponible. N’hésitez pas à consulter
                                tous
                                ces
                    ...
                    <tr>
                        ...
                        <td colspan="2"><input type="text" name="con" size="4" maxlength="2"
                                               value="<?php echo $def_con; ?>"
                                               onBlur="verif_carac(3);"></td>
                    </tr>
                    <tr>
                        <td><p>Intelligence : </p></td>
                        <td colspan="2"><input type="text" name="intel" size="4" maxlength="2"
                                               value="<?php echo $def_int; ?>"
                        ...
                        <td width="30%">
                            <select name="voie" onChange="javascript:setText('explication','explication');">
                                ...
                                <option value="guerrier"
                                        onChange="javascript:setText('explication',explication['guerrier']);">
                                    La voie de l'aventurier
                                </option>
                                <option value="bucheron"
                                        onChange="javascript:setText('explication',explication['bucheron']);">
                                    La voie du barbare
                                </option>
                                <option value="monk" onChange="javascript:setText('explication',explication['monk']);">
                                    La
                                    voie
                                    du lutteur
                                </option>
                                <option value="archer"
                                        onChange="javascript:setText('explication',explication['monk']);">La
                                    voie
                                    de l'archer
                                </option>
                                <option value="mage" onChange="javascript:setText('explication',explication['mage']);">
                                    La
                                    voie
                                    du mage
                                </option>
                                <option value="explo"
                                        onClick="javascript:setText('explication',explication['explorateur']);">La
                                    voie de l'explorateur
                                </option>
                                <option value="mineur"
                                        onClick="javascript:setText('explication',explication['mineur']);">La
                                    voie du mineur
                                </option>
                            </select><br>
                    ...
                    <tr>
                        <td colspan="3"><em>N.B. : afin d’éviter tout abus, tous les objets créés lors de l’activation
                                de
                                l’aventurier ne peuvent pas tomber de son inventaire en cas de mort.<br>
                                De plus, les runes et parchemins ne pourront pas faire l’objet de transactions vers des
                                échoppes
                    ...
                    <tr>
                        <td colspan="3"><br><strong>INFORMATION IMPORTANTE :</strong>
                            <br>Dans l’univers que vous allez aborder, les interactions entre joueurs sont très
                            nombreuses.
                            Elles sont souvent le fait de l’histoire de ce monde, mais aussi des rencontres et des
                            péripéties
                            qui s’y sont créées et que les aventuriers ont créées par leur Role Play (et voilà, si ce
                            terme
                            barbare ne se trouve pas dans ton lexique, c’est que tu n’as pas lu suffisamment bien les
                            règles.
                            N’hésites pas à retourner les consulter). Parfois ces interactions sont violentes et se
                            finissent
                            dans des combats entre aventuriers.<br>
                            <br>
                            Dans notre monde sans pitié, le roi de ces contrées, Hormandre III, a mandaté une milice
                            pour
                            faire
                            régner l’ordre, mais de nombreux troubles perturbent encore le secteur. Cette milice a pris
                            en
                            charge une partie des deux premiers niveaux uniquement, et impose la loi d’Hormandre, par
                            tous
                            les
                            moyens. Faites attention, la loi est la loi.<br>
                            Mais un de ses voisins ne voit pas d’un très bon œil cette loi catégorique et inique qui
                            n’est
                            pas
                            la sienne. Sal’Morv, a donc engagé des troupes pour faire régner sa loi, c’est à dire
                            aucune.
                            Vol,
                            violence et racket sont ses jeux favoris, et que le meilleur gagne.<br>
                            Suite à une guerre impitoyable, un traité a été établi afin de laisser une partie des deux
                            premiers
                            niveaux à disposition de Sal’Morv. Ainsi, chaque souverain peut assouvir ses envies, la
                            lutte
                            contre
                            Malkiar pour l’un, la lutte pour la survie des plus forts pour l’autre.<br>
                            <br>
                            Vous qui rentrez dans ces souterrains, vous aurez votre destin entre vos mains. A vous de
                            choisir la
                            meilleure situation pour votre départ, mais sachez que les conséquences seront immédiates,
                            d’un
                            côté
                            comme de l’autre.<br>
                            Sur les terres d’Hormandre, la milice jouera son rôle, alors que dans le secteur de
                            Sal'Morv, la
                            loi
