...
<div class="bordiv" style="margin:2px;text-align:center">
    <table>
        ...
        <td style="width:800px;"><i>
                <center>
                    <hr>
                    <b>Aventurier, baladin, réfugié, bandit de grand chemin, te voici arrivé sur les terres du royaume
                        de Delain... Ou plutôt devrait-on dire... sous les terres.</b><br>
                    Là où s’éveille depuis peu un mal très ancien ; dans les ténèbres de ces cavernes au plus profond
                    desquelles Malkiar le Rouge reprend lentement ses forces et envoie ses hordes démoniaques à l’assaut
                    des extérieurs...
                    Sauras-tu surmonter les mille épreuves qui se dresseront devant toi, affronter les dangers de cette
                    vie souterraine ? Pourras-tu protéger les contrées extérieures de ce mal grandissant ?
                    <br><b>Entre, et trouve par toi-même les réponses à ces questions.</b>
                    <br/>Mais attention : aujourd’hui, dans les souterrains, <?php echo $param->getparm(64); ?>
                    aventuriers, <?php echo $param->getparm(65); ?> monstres et <?php echo $param->getparm(66); ?>
                    familiers sont morts au combat...
                </center>
            </i>
            <hr>
        </td>
        <td>
            ...
            if ($nb_pub == 1) {
                ?>
                <iframe src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fpages%2FLes-souterrains-de-Delain%2F185893811435175&amp;width=292&amp;colorscheme=dark&amp;show_faces=false&amp;stream=false&amp;header=false&amp;height=62"
                ...
                ?>
                <img src="http://images.jdr-delain.net/avatars/<?php echo $image ?>"
    ...
    <br><b>Les souterrains de Delain</b> est un jeu de rôles en ligne, où vous pouvez incarner jusqu’à 3 aventuriers. Il
    se déroule en tour par tour, et les seuls outils nécessaires pour y jouer sont une connexion internet, un
    navigateur, et une adresse mail.
    Pour plus d’infos : <a href="aide.php">comment débuter</a>, <a href="regles.php">les règles</a>, et <a
            href="faq_v2.php">la faq</a>.<br><br>
</div>
