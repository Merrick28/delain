...
{
    $g1 = ($compt_cod == $result['cmon_compt_cod']) ? '<strong>' : "";
    $g2 = ($compt_cod == $result['cmon_compt_cod']) ? '</strong>' : "";

    $contenu_page .= "<tr>";
    $contenu_page .= "<td class=\"soustitre2\">$g1" . $result['cmon_nom'] . "$g2</td>";
    $contenu_page .= "<td>" . $result['cmon_renommee_txt'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_renommee_magique_txt'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_karma_txt'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_kill_perso'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_kill_monstres'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_px_txt'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_description'] . "</td>";
    $contenu_page .= "<td>" . $result['cmon_fin'] . "</td>";
    $contenu_page .= "</tr>";
}
$contenu_page .= ("<tr><td>");
if ($debut != 0)
