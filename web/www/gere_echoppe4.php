...
case "debut":
    ...
    if ($modif_possible == 1) {
        echo "<tr>";
        echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><strong><a href=\"gere_echoppe4.php?mag=$mag&methode=mod\">Modifier ces données</a></strong></td>";
        echo "</tr>";

        echo "<tr>";
        echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><strong><a href=\"gere_echoppe4.php?mag=$mag&methode=nom\">Changer le nom et la description</a></strong></td>";
        echo "</tr>";

        echo "<tr>";
        echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><strong><a href=\"gere_echoppe4.php?mag=$mag&methode=vente_adm\">Vendre du matériel à l'administration</a></strong></td>";
        echo "</tr>";

        echo "<tr>";
        echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><strong><a href=\"gere_echoppe4.php?mag=$mag&methode=achat_adm\">Acheter du matériel à l'administration</a></strong></td>";
        echo "</tr>";

        echo "<tr>";
        echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><strong><a href=\"gere_echoppe4.php?mag=$mag&methode=fix_prix\">Fixer les tarifs</a></strong></td>";
        echo "</tr>";

        echo "<tr>";
        echo "<td colspan=\"2\" class=\"soustitre2\"><p style=\"text-align:center\"><strong><a href=\"gere_echoppe4.php?mag=$mag&methode=stats\">Voir les stats</a></strong></td>";
        echo "</tr>";
    }
...
case "banque":
    ...
    echo "<div class=\"centrer\"><input type=\"submit\" class=\"test\" value=\"Valider le transfert ?\"></div>";
    echo "</form>";
    break;
case "banque2":
    $req = "select lieu_compte,perso_po ";
...
case "marge":
    ...
    $db->query($req);
    $db->next_record();
    $ancienne_marge = $db->f("lieu_marge");
    ...
    echo "<div class=\"centrer\"><input type=\"submit\" class=\"test\" value=\"Valider le changement ?\"></div>";
    echo "</form>";
...
case "fix_prix":
    ...
    while ($db->next_record()) {
        ...
        echo "<td><a href=\"gere_echoppe4.php?mag=$mag&methode=fix_prix2&gobj=" . $db->f("gobj_cod") . "\">Modifier !</a></td>";
        echo "</tr>";
    }
    echo "<tr>";
    echo "<td colspan=\"5\"><div class=\"centrer\"><input type=\"submit\" value=\"Valider les achats !\" class=\"test\"></div></td>";
...
case "fix_prix2":
    ...
    echo "<div class=\"centrer\"><input type=\"submit\" value=\"Valider\" class=\"test\"></div>";
    echo "</form>";
    break;
case "fix_prix3":
    $erreur = 0;
...
<table>
    ...
    echo "</table>";
    echo "<p style=\"text-align:center\"><a href=\"gere_echoppe4.php?mag=$mag&methode=stats2\">Voir le détail</a>";
    }
    ...
    <table>
        ...
        <form name="aligne" method="post" action="gere_echoppe4.php">
            ...
            <div class="centrer"><input type="submit" class="test" value="Valider les changements !"></div>
            <?php
            break;
            case "align2":
                $erreur = 0;
            ...
            echo "<p style=\"text-align:center;\"><a href=\"gere_echoppe3.php?mag=$mag\">Retour à la gestion de l'échoppe</a>";
