...
$phpbb_root_path = '/home/sdewitte/public_html/forum/';
...
$template->assign_vars(array(
   ...
   'BOARD_URL' => htmlspecialchars( $index_url ),
   'BOARD_TITLE' => htmlspecialchars( $site_name ),
   'BOARD_DESCRIPTION' => htmlspecialchars( $site_description ),
   ...
   'L_AUTHOR' => htmlspecialchars( $lang['Author'] ),
