...
<div id="colonne1">
    <div id="dropdown-box">
        ...
        <div style="text-align:center;padding:5px">
            ...
            <div id="xp" style="padding:0px"><img src="{URL_IMAGES}iconexp.gif" alt="">
                <div title="{PERSO_PX} PX, prochain niveau à {PERSO_PROCHAIN_NIVEAU}"
                     alt="{PERSO_PX}/{PERSO_PROCHAIN_NIVEAU} PX" class="container-xp">
    ...
    <div id="dropdown-menu" class="dropdown-content">
        ...
        <div id="transaction"><img src="{URL_IMAGES}transaction.gif" alt=""> <a
                    href="{URL_RELATIVE}transactions2.php">{TRANSACTIONS}</a></br></div>
        <hr/>
        ...
        {VOL}
        <hr/>
        <div id="messagerie"><img src="{URL_IMAGES}messagerie.gif" alt=""> <a
                    href="{URL_RELATIVE}messagerie2.php">{PERSO_MESSAGERIE}</a></div>
        ...
        {COMMANDEMENT}
        {OPTION_MONSTRE}
        <img src="{URL_IMAGES}iconeswitch.gif" alt=""> <a href="{URL_RELATIVE}switch.php"><strong>Gestion
                compte</strong></a>
        <hr/>
        <img src="{URL_IMAGES}forum.gif" alt=""> <a href="http://forum.jdr-delain.net" target="_blank">Forum</a> - <a
                href="https://forum.jdr-delain.net/app.php/chat/popup" target="_blank">Chat</a> -{WIKI}<br>
