<?php /* Smarty version Smarty-3.1-DEV, created on 2014-04-27 14:55:29
         compiled from "/home/delain/public_html/api/game/template/gen_xml.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1566751718535cfe41a66788-35020563%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8b453f90b1188906b77b553bb625395b154a1924' => 
    array (
      0 => '/home/delain/public_html/api/game/template/gen_xml.tpl',
      1 => 1309439145,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1566751718535cfe41a66788-35020563',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_535cfe41a78629_45293911',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_535cfe41a78629_45293911')) {function content_535cfe41a78629_45293911($_smarty_tpl) {?><?php echo '<?xml';?> version="1.0" encoding="UTF-8"<?php echo '?>';?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['data']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['name'];?>
 valeur="<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['valeur'];?>
" />
<?php endfor; endif; ?>
</<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
>
