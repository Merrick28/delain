...
VALUES ('132204', 'Résurrection de familier', 'magie_resurrection_fam', 10,
...
select 175,gobj_cod from objet_generique where gobj_rune_position = 1 and gobj_frune_cod = 1
UNION 
select 175,gobj_cod from objet_generique where gobj_rune_position = 3 and gobj_frune_cod = 2
UNION
select 175,gobj_cod from objet_generique where gobj_rune_position = 2 and gobj_frune_cod = 3
UNION
select 175,gobj_cod from objet_generique where gobj_rune_position = 2 and gobj_frune_cod = 4
UNION
