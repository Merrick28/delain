 INSERT INTO quetes.aquete_etape_modele(  aqetapmodel_tag, aqetapmodel_nom, aqetapmodel_description, aqetapmodel_parametres, aqetapmodel_param_desc, aqetapmodel_modele)
    VALUES ('#SAUT #CONDITION #CARAC',
            ...
            'Cette étape sert faire un saut d''étape conditionné par un jet de dé sous une caractéristique du meneur, vous pouvez utiliser le paramètre [[#aqaction]] comme résultat du lancé de dé.',
...
update  quetes.aquete_etape_modele set aqetapmodel_modele='[[#aqaction]]', aqetapmodel_description='Cette étape sert faire un saut d''étape conditionné par un jet de compétence, vous pouvez utiliser le paramètre [[#aqaction]] comme résultat du lancé de dé.' where aqetapmodel_tag = '#SAUT #CONDITION #COMPETENCE';